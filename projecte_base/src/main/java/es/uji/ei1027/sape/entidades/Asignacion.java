...
public class Asignacion {
	...
	public final void setFechaPropuesta(Date fechaPropuesta) {
		this.fechaPropuesta = fechaPropuesta;
	}
	public final Date getFechaCambioEstado() {
		return fechaCambioEstado;
	}
	public final void setFechaCambioEstado(Date fechaCambioEstado) {
		this.fechaCambioEstado = fechaCambioEstado;
	}
	public final Date getFechaTraspasoIGLU() {
		return fechaTraspasoIGLU;
	}
	public final void setFechaTraspasoIGLU(Date fechaTraspasoIGLU) {
		this.fechaTraspasoIGLU = fechaTraspasoIGLU;
	}
	public final String getComentarioPerCambio() {
		return comentarioPerCambio;
	}
	public final void setComentarioPerCambio(String comentarioPerCambio) {
		this.comentarioPerCambio = comentarioPerCambio;
	}
	public final MenuEstado getEstado() {
		return estado;
	}
	public final void setEstado(MenuEstado estado) {
		this.estado = estado;
	}
